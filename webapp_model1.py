...
known_turbine_types = np.load("model1/turbine_types_order.npy")
...
# Lade den Scaler
scalers = joblib.load("model1/scalers.pkl")
...
# Lade die Metadaten
input_size = torch.load("model1/input_size", weights_only=True)
model = MLP(input_size=input_size)

# Lade die Modellgewichte
model.load_state_dict(torch.load("model1/trained_parameters.pth", weights_only=True))
